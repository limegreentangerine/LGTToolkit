<?php defined('C5_EXECUTE') or die('Access Denied.');
     ...
     * @param integer   $width (optional) - Max width of image
     * @param integer   $height (optional) - Max height of image
     * @param boolean   $cropImage (optional) - When resizing crop the image
     * @param boolean   $forceSize (optional) - Forces the size set in width/height params
     * @param boolean   $lazyLoad (optional) - Turn on browser based "lazy" property, set to TRUE by default
     * @param boolean   $useCaption (optional) - If set to TRUE wraps picture element in figure element with figcaption
     * @param boolean   $useFocalPoint (optional) - If set to TRUE sets the focal point value as the image centre
     *
     * @return void
     */
