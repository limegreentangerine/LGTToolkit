...
<?php if (isset($view) && isset($token)) { ?>
    <?php if (isset($pkg) && ($pkg->getFileConfig()->get('lgt_toolkit.cloudflare.zone_id') !== null && $pkg->getFileConfig()->get('lgt_toolkit.cloudflare.zone_id') !== '')) { ?>
        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" id="activate" name="activate" class="form-check-input" value="1" <?php echo (isset($formContent) && isset($formContent['activate'])) ? 'checked' : ((isset($pkg) && $pkg->getFileConfig()->get('lgt_toolkit.cloudflare.activate') == true) ? 'checked' : ''); ?> />
            ...
            <div class="form-group">
                ...
                <?php echo $form->text('base_url', (isset($formContent)) ? $formContent['base_url'] : ((isset($pkg) && $pkg->getFileConfig()->get('lgt_toolkit.cloudflare.base_url') !== null) ? $pkg->getFileConfig()->get('lgt_toolkit.cloudflare.base_url') : 'https://api.cloudflare.com/client/v4')); ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php echo $form->text('zone_id', (isset($formContent)) ? $formContent['zone_id'] : (isset($pkg) ? $pkg->getFileConfig()->get('lgt_toolkit.cloudflare.zone_id') : false)); ?>
            ...
            <div class="form-group">
                ...
                <?php echo $form->text('token', (isset($formContent)) ? $formContent['token'] : (isset($pkg) ? $pkg->getFileConfig()->get('lgt_toolkit.cloudflare.token') : false)); ?>
                <div class="help-block"><?php echo t('Permissions: <code>Zone.Zone Settings</code>'); ?></div>
            </div>
        </fieldset>

        <?php if (isset($pkg) && $pkg->getFileConfig()->get('lgt_toolkit.cloudflare.activate') == true) { $this->controller->getCloudflareDevelopmentMode(); ?>
            <fieldset>
                <legend><?php echo t('Development Mode Status'); ?></legend>

                <div class="form-group">
                    <p><?php echo t('Development mode is: <code>%s</code>', $this->controller->getCloudflareDevelopmentMode()); ?></p>
                </div>
            </fieldset>
        <?php } ?>
